...
public class MenuItem {
	...
	public void addMenuItemReviews(MenuItemReview menuItemReview) {
		if (menuItemReviews == null) {
			menuItemReviews = new ArrayList<>();
		}
		if (!menuItemReviews.contains(menuItemReview)) {
			menuItemReviews.add(menuItemReview);
			menuItemReview.setMenuItem(this);
		}
	}

	public void removeMenuItemReviews(MenuItemReview menuItemReview) {
		if (menuItemReviews != null && menuItemReviews.contains(menuItemReview)) {
			menuItemReviews.remove(menuItemReview);
			menuItemReview.setMenuItem(null);
		}
	}
