...
INSERT INTO `restaurant` (`id`, `name`, `restaurant_url`, `image_url`, `phone_number`, `address_id`, `enabled`, `description`) VALUES (72, 'Yours Truly Cupcake', 'https://yourstrulycupcake.com/', 'assets/cupcake', '303.638.3528', 72, 1, 'At Yours Truly Cupcake, we can’t wait to sweeten your celebration. We are a full service dessert catering company & bakery located in the RiNo Arts District of Denver.');
